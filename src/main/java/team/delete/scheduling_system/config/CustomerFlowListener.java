 ...
 */
@Slf4j
public class CustomerFlowListener implements ReadListener<CustomerFlow> {
     ...
     *
     * @param customerFlowMapper
     */
    public CustomerFlowListener(CustomerFlowMapper customerFlowMapper) {
        this.customerFlowMapper = customerFlowMapper;
    }
